...
# Compute rin/rout of all vertexes at instant.
...
# Intermediate function that do the dirty work
...
# A nb_in_out version with arrays (for memory sake)
...
# Computes rin for a specific vertex.
...
# Computes rout for a specific vertex.
...
# Computes rin/rout for a specific vertex every "each".
